...
@export var material:ShaderMaterial = preload("res://Ocean.tres")
...
func _initialize_simulation() -> void:
	...
	## Compile Shader
	shader_file = load("res:InitialSpectrum.glsl")
	...
	## Compile Shader
	shader_file = load("res://Phase.glsl")
	...
	## Compile Shader
	shader_file = load("res://Spectrum.glsl")
	...
	## Compile Shaders
	shader_file = load("res://FFTHorizontal.glsl")
	...
	shader_file = load("res://FFTVertical.glsl")
